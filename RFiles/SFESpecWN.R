...
# Quantlet:     SFESpecWN
# ------------------------------------------------------------------------------
# Description:  SFESpecWN computes the spectrum (frequency domain representation)
...
abline(h=0,lty=3)
spec.pgram(x,log="no",xlab="frequency",main="",lwd=2,cex.lab=2.1,cex.axis=2,sub="",ylab="Spectrum")
